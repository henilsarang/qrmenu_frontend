        ...
        <Col xs={7} className="d-flex flex-column justify-content-between W-100">
            <div>
                <div className="d-flex justify-content-between align-items-center w-100">
                    ...
                    <div>
                        {onEdit ? (<Button variant="link" onClick={onEdit}><BiEdit size={20} /></Button>) : null}
                        {onRemove ? (<Button variant="link" onClick={onRemove}><AiOutlineDelete size={20} color="red"/></Button>) : null}
            ...
            <div className="d-flex justify-content-between align-items-end">
                <div>
                    <h5 className="mb-0 text-standard"><b style={{color:color}}>${item.price}</b></h5>
                    {onOrder ? (
